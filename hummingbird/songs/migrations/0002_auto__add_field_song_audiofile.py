...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.audiofile'
        db.add_column(u'songs_song', 'audiofile',
                      self.gf('audiofield.fields.AudioField')(default='endless_sacrifice.mp3', ext_whitelist=['.mp3', '.wav', '.ogg'], max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Song.audiofile'
        db.delete_column(u'songs_song', 'audiofile')
