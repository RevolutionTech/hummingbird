...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.audiofile'
        db.alter_column(u'songs_song', 'audiofile', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Song.audiofile'
        db.alter_column(u'songs_song', 'audiofile', self.gf('audiofield.fields.AudioField')(ext_whitelist=['.mp3', '.wav', '.ogg'], max_length=100))
