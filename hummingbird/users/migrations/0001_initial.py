...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_userprofile', (
            ...
            ('mac_address', self.gf('django.db.models.fields.CharField')(unique=True, max_length=17, db_index=True)),
            ('walkin_song', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['songs.SongAssignment'], null=True, blank=True)),
            ('delay', self.gf('django.db.models.fields.IntegerField')(default=15, blank=True)),
            ('most_recent_activity', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
